...
export const LEVELS: LevelConfig[] = [
  {
    ...
    boss: { name: 'ZUMBI-CHEFE', hp: 56, moveSpeed: 60 },
  },
  {
    id: 'ieab',
    name: 'IEAB',
    ...
    difficulty: {
      ...
      spawnStartDelay: 1900,
      spawnMinDelay: 350,
      difficultyRampMs: 90_000,
    },
    boss: { name: 'GUARDIÃO DO IEAB', hp: 72, moveSpeed: 68 },
  },
  {
    id: 'castro-alves',
    name: 'CASTRO ALVES',
    ...
    difficulty: {
      ...
      spawnStartDelay: 1600,
      spawnMinDelay: 300,
      difficultyRampMs: 80_000,
    },
    boss: { name: 'POETA SOMBRIO', hp: 96, moveSpeed: 76 },
  },
  {
    id: 'cetep',
    name: 'CETEP',
    ...
    victoryKills: 35,
    difficulty: {
      maxSimultaneousZombies: 20,
      spawnStartDelay: 1400,
      spawnMinDelay: 250,
      difficultyRampMs: 70_000,
    },
    boss: { name: 'MESTRE TÉCNICO', hp: 120, moveSpeed: 84 },
  },
]
